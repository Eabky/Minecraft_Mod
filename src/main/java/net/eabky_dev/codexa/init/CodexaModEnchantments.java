...
public class CodexaModEnchantments
{
    ...
    static
    {
        ...
        LIGHTNING_STRIKE_ENCHANTMENT = REGISTRY.register("lightning_strike_enchantment", ()-> new LightningStrikeEnchantment(Enchantment.Rarity.VERY_RARE, EnchantmentCategory.WEAPON, new net.minecraft.world.entity.EquipmentSlot[]{net.minecraft.world.entity.EquipmentSlot.MAINHAND}));
